export type ApiDate = { date: string; timezone?: string; timezone_type?: number } | null;

export type ImagemComitente = { thumb?: string | null; full?: string | null } | null;

export type ImagemLeilao =
    | {
        full?: { url?: string | null; resolution?: { width?: number; height?: number } | null } | null;
        thumb?: { url?: string | null; resolution?: { width?: number; height?: number } | null } | null;
        min?: { url?: string | null; resolution?: { width?: number; height?: number } | null } | null;
    }
    | null;
